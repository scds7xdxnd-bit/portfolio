...
const TRANSLATIONS = {
  en: {
    ...
    'spec.linguist.stat2':'6 organizations',
    ...
    'spec.engineer.featuredTitle':'Fugacity Simulator',
    'spec.engineer.featuredDesc':'Interactive thermodynamics tool plotting vapor/liquid fugacity vs. pressure (implements the fugacity-coefficient integrals), zoom/pan, log-linear toggle, multi-temperature overlay. Vanilla JS + HTML5 Canvas.',
    ...
    'spec.engineer.item3.desc':'Office hours, grading, recitation sections (Spring 2026).',
    ...
    'spec.scholar.stat1':'₩73,014,500',
    'spec.scholar.stat2':'7 scholarships',
    'spec.scholar.stat3':'4 institutions',
    'spec.scholar.mastery':'80%',
    'spec.scholar.headline':'₩73,014,500 in scholarships — 7 awards across 4 institutions.',
    'spec.scholar.featuredTitle':'Samsung Dream Scholarship (Global Hope)',
    'spec.scholar.featuredDesc':'₩22.2M over 5 semesters, competitively selected via school nomination + Samsung Foundation panel. Differentiators: TOPIK 6, deliberate Korean-language investment, dual degree.',
    'spec.scholar.item1.title':'Sogang 1st-Class Admission Scholarship',
    'spec.scholar.item1.desc':'Full tuition, ₩42.22M across 7 semesters.',
  ...
  zh: {
    ...
    'spec.engineer.featuredTitle':'逸度模拟器',
    'spec.engineer.featuredDesc':'交互式热力学工具，绘制气/液逸度与压力关系图（实现逸度系数积分），支持缩放、对数/线性轴切换、多温度叠加。原生JS + HTML5 Canvas。',
    ...
    'spec.engineer.item3.desc':'答疑课、批改作业、习题课（2026年春季）。',
    ...
    'spec.scholar.mastery':'80%',
    'spec.scholar.headline':'₩73,014,500奖学金——7项，来自4所机构。',
    'spec.scholar.featuredTitle':'三星梦想奖学金（全球希望）',
    'spec.scholar.featuredDesc':'5个学期共₩22.2M，经学校提名+三星基金会评审团竞争选拔。核心优势：TOPIK 6、系统性韩语投入、双学位。',
    'spec.scholar.item1.title':'西江大学一等入学奖学金',
    'spec.scholar.item1.desc':'全额学费，7学期共₩42.22M。',
  ...
  ko: {
    ...
    'spec.engineer.featuredTitle':'퓨가시티 시뮬레이터',
    'spec.engineer.featuredDesc':'기/액상 퓨가시티 대 압력 그래프를 그리는 인터랙티브 열역학 도구(퓨가시티 계수 적분 구현), 확대/축소, 로그-선형 전환, 다중 온도 오버레이. Vanilla JS + HTML5 Canvas.',
    ...
    'spec.engineer.item3.desc':'오피스 아워, 채점, 보충 수업 (2026년 봄학기).',
    ...
    'spec.scholar.mastery':'80%',
    'spec.scholar.headline':'₩73,014,500 장학금 — 4개 기관에서 7개 수상.',
    'spec.scholar.featuredTitle':'삼성 꿈장학금 (글로벌 희망)',
    'spec.scholar.featuredDesc':'5학기 합계 ₩22.2M, 학교 추천 + 삼성재단 심사를 통해 경쟁 선발. 차별점: TOPIK 6, 의도적인 한국어 투자, 복수전공.',
    'spec.scholar.item1.title':'서강대 1등 입학 장학금',
    'spec.scholar.item1.desc':'전액 장학금, 7학기 합계 ₩42.22M.',
...
const SPECIALIZATIONS = [
  ...
  },
  {
    ...
    accent: 'coral',
    mastery: 75,
    featuredUrl: 'https://fugacity-simulator.vercel.app',
  ...
  },
  {
    ...
    certs: [
      ...
      { filename: '20251_scholarship_cert', name: 'Samsung Dream Scholarship (2025-1)', icon: '⭐' },
      { filename: '20261_scholarship_cert', name: 'Samsung Dream Scholarship (2026-1)', icon: '⭐' },
