export const ACHIEVEMENTS = [
  ...
  { id: 'interrogator',  icon: '🗣️', titleKey: 'ach.interrogator.title',  descKey: 'ach.interrogator.desc' },
...
export const BASE_ACH = ['polyglot', 'tinkerer', 'deepdiver', 'reachout', 'interrogator', 'secret'];
export const ACH_KEY = 'th_achievements';
