...
export const TRANSLATIONS = {
  en: {
    ...
    'spec.featuredLabel':'Featured',
    'spec.simLabel':'TRY IT YOURSELF',
    ...
    'spec.engineer.featuredDesc':'Interactive CSTR/PFR reactor network simulator with Levenspiel plots, conversion & temperature profiles, thermal operating diagram, and dynamic response with disturbance injection. React + TypeScript + Recharts. Validated against analytic solutions: a recycle tear-stream defect was located by reproducing 1 − exp(−kτ) exactly with the recycle removed, then fixed and pinned by a regression suite (240 tests green).',
    'spec.engineer.featuredLinkLabel':'Live',
    'spec.engineer.item7.title':'QM Property Predictor',
    'spec.engineer.item7.desc':'Does quantum chemistry actually improve molecular property prediction? Ran B3LYP/6-31G* on 200 molecules with PySCF and measured it properly \u2014 scaffold k-fold, paired bootstrap, and noise controls. Answer: no, once fingerprints and RDKit descriptors are in hand. The live predictor ships a TreeSHAP explanation and an applicability-domain warning with every prediction. PySCF \u00B7 RDKit \u00B7 XGBoost \u00B7 PyTorch.',
    ...
    'spec.builder.stat2':'9 deployed',
    'spec.builder.stat3':'Full-stack + ML',
    'spec.builder.mastery':'9 deployed apps',
    'spec.builder.headline':'Five years building. Nine deployed systems across full-stack, ML, and organizational software.',
    ...
    'spec.builder.item6.title':'GLEAM Governance Platform',
    'spec.builder.item6.desc':'Bilingual (EN/KO) coordination system for the Global Hope Scholars Student Council — member portal with a club → period → event hierarchy, an admin governance module, and a club-report export renderer. Next.js App Router + Supabase.',
    'spec.builder.item7.title':'Yummz',
    'spec.builder.item7.desc':'Event and community platform for the International Student Council — RSVPs, organiser portal, opt-in event chat with moderation and retention jobs. Next.js + Drizzle ORM + Postgres.',
    ...
    'spec.community.item7.title':'Samsung Leadership Camp Simulator ↗',
    'spec.community.item7.desc':'Interactive name-sticker exchange sim: optimizes groupings across 270 scholars, then simulates the festival itself. Play it live →',
    'spec.community.item8.title':'Korean Language Support (Refugee)',
    'spec.community.item8.desc':'One-to-one Korean-language learning support for a Somalian refugee, connected through Sogang University.',
    ...
    'spec.scholar.featuredLinkLabel':'Samsung Dream webzine feature',
    ...
    'journey.2021':'First app shipped — personal accounting system (still running)',
    'journey.2022':'Sogang University — dual degree + full-tuition scholarship',
    'journey.2023':'Interpreter for Supreme Prosecutors\' Office · TOPIK 6 (265/300)',
    'journey.2024':'PALS Co-President · Samsung Dream Scholar · 4 apps deployed',
    'journey.2025':'APEC interpreter (Yonhap News) · LifeOS launched · 6 apps live',
    'journey.now.year':'2026 →',
    'journey.2026':'BLCU exchange · TA at Sogang · Building in public',
    'manifesto.now.label':'Now',
    'manifesto.now.building':'TA for Chemical Engineering at Sogang',
    'manifesto.now.where':'Seoul, back from BLCU exchange',
    'manifesto.now.updated':'Updated Jun 2026',
    'langquiz.title':'Guess the Language',
    'langquiz.sub':'Which language is this?',
    'langquiz.q':'Question',
    'langquiz.result':'{score}/{total} correct',
    'langquiz.retry':'Play again →',
  ...
  zh: {
    ...
    'spec.engineer.featuredDesc':'交互式 CSTR/PFR 反应器网络模拟器，含 Levenspiel 图、转化率与温度分布、热操作线图以及带扰动注入的动态响应。React + TypeScript + Recharts。通过解析解验证：移除循环后精确复现 1 − exp(−kτ)，据此定位并修复了循环撕裂流缺陷，并以回归测试固定（240项测试全绿）。',
    'spec.engineer.featuredLinkLabel':'在线演示',
    'spec.engineer.item7.title':'量子化学性质预测器',
    'spec.engineer.item7.desc':'量子化学特征真能提升分子性质预测吗？用 PySCF 对 200 个分子跑 B3LYP/6-31G*，并以骨架交叉验证、配对自展法与噪声对照严格衡量。结论：在已有分子指纹和 RDKit 描述符的前提下，并没有。在线预测器为每个结果附上 TreeSHAP 解释与适用域警告。PySCF · RDKit · XGBoost · PyTorch。',
    ...
    'spec.builder.stat2':'9个已部署',
    'spec.builder.stat3':'全栈 + ML',
    'spec.builder.mastery':'9个已部署项目',
    'spec.builder.headline':'五年构建经验，九个已上线系统，涵盖全栈、机器学习与组织运营软件。',
    'spec.builder.featuredTitle':'LifeOS',
    ...
    'spec.builder.item6.title':'GLEAM 治理平台',
    'spec.builder.item6.desc':'为 Global Hope Scholars 学生会打造的英韩双语协作系统——成员门户（社团→届期→活动层级）、管理端治理模块、社团报告导出渲染器。Next.js App Router + Supabase。',
    'spec.builder.item7.title':'Yummz',
    'spec.builder.item7.desc':'为国际学生会打造的活动与社群平台——报名管理、主办方后台、可选开启的活动聊天（含审核与数据留存任务）。Next.js + Drizzle ORM + Postgres。',
    ...
    'spec.community.item7.title':'三星领导力营地模拟器 ↗',
    'spec.community.item7.desc':'互动名牌交换模拟器：优化270名学者的分组，并模拟整个节日流程。立即体验 →',
    'spec.community.item8.title':'韩语学习支持（难民）',
    'spec.community.item8.desc':'通过西江大学结对，为一名索马里难民提供一对一韩语学习支持。',
    ...
    'spec.scholar.featuredLinkLabel':'三星梦想奖学金网刊报道',
    ...
    'journey.label':'历程',
    'journey.2021':'第一个应用上线 — 个人记账系统（持续运营中）',
    'journey.2022':'西江大学 — 双学位 + 全额奖学金',
    'journey.2023':'最高检察院口译 · TOPIK 6（265/300）',
    'journey.2024':'PALS 联合主席 · 三星梦想学者 · 4款应用上线',
    'journey.2025':'APEC口译（联合新闻） · LifeOS上线 · 6款应用运营',
    'journey.now.year':'2026 →',
    'journey.2026':'北京语言大学交流 · 西江大学助教 · 持续创作',
    'manifesto.now.label':'现在',
    'manifesto.now.building':'西江大学化学工程助教',
    'manifesto.now.where':'首尔，刚结束北京语言大学交流',
    'manifesto.now.updated':'更新于 2026年6月',
    'langquiz.title':'猜语言',
    'langquiz.sub':'这是哪种语言？',
    'langquiz.q':'第',
    'langquiz.result':'{score}/{total} 题正确',
    'langquiz.retry':'再玩一次 →',
  ...
  ko: {
    ...
    'spec.engineer.featuredDesc':'대화형 CSTR/PFR 반응기 네트워크 시뮬레이터 — Levenspiel 플롯, 전환율·온도 프로파일, 열 운전선도, 외란 주입이 포함된 동적 응답. React + TypeScript + Recharts. 해석해로 검증: 재순환을 제거했을 때 1 − exp(−kτ)를 정확히 재현하여 tear stream 결함을 특정하고 수정, 회귀 테스트로 고정(240개 테스트 통과).',
    'spec.engineer.featuredLinkLabel':'라이브',
    'spec.engineer.item7.title':'양자화학 물성 예측기',
    'spec.engineer.item7.desc':'양자화학 특성이 실제로 분자 물성 예측을 개선하는가? PySCF로 200개 분자에 B3LYP/6-31G*를 수행하고 스캐폴드 교차검증·쌍대 부트스트랩·노이즈 대조군으로 엄밀하게 측정. 결론: 핑거프린트와 RDKit 기술자가 있는 한 효과 없음. 라이브 예측기는 모든 예측에 TreeSHAP 설명과 적용 범위 경고를 함께 제공. PySCF · RDKit · XGBoost · PyTorch.',
    ...
    'spec.builder.stat2':'9개 배포',
    'spec.builder.stat3':'풀스택 + ML',
    'spec.builder.mastery':'배포 앱 9개',
    'spec.builder.headline':'5년 빌딩. 풀스택·ML·조직 운영 소프트웨어를 아우르는 9개 배포 시스템.',
    'spec.builder.featuredTitle':'LifeOS',
    ...
    'spec.builder.item6.title':'GLEAM 거버넌스 플랫폼',
    'spec.builder.item6.desc':'글로벌희망장학생 학생회를 위한 한/영 이중언어 운영 시스템 — 동아리 → 기수 → 행사 계층의 멤버 포털, 관리자 거버넌스 모듈, 동아리 보고서 내보내기 렌더러. Next.js App Router + Supabase.',
    'spec.builder.item7.title':'Yummz',
    'spec.builder.item7.desc':'국제학생회를 위한 행사·커뮤니티 플랫폼 — 참가 신청, 주최자 포털, 선택형 행사 채팅(모더레이션·보존 정책 포함). Next.js + Drizzle ORM + Postgres.',
    ...
    'spec.community.item7.title':'삼성 리더십 캠프 시뮬레이터 ↗',
    'spec.community.item7.desc':'인터랙티브 이름 스티커 교환 시뮬레이터: 270명 학자 그룹 최적화 후 축제 시뮬레이션. 직접 플레이 →',
    'spec.community.item8.title':'한국어 학습 지원 (난민)',
    'spec.community.item8.desc':'서강대학교를 통해 연결된 소말리아 난민 1인에게 제공한 1:1 한국어 학습 지원.',
    ...
    'spec.scholar.featuredLinkLabel':'삼성 드림 웹진 소개',
    ...
    'journey.label':'여정',
    'journey.2021':'첫 번째 앱 출시 — 개인 회계 시스템（현재도 운영 중）',
    'journey.2022':'서강대학교 — 복수전공 + 전액 장학금',
    'journey.2023':'대검찰청 통역 · TOPIK 6급（265/300）',
    'journey.2024':'PALS 공동 회장 · 삼성 드림 장학생 · 앱 4개 배포',
    'journey.2025':'APEC 통역（연합뉴스 보도） · LifeOS 출시 · 앱 6개 운영',
    'journey.now.year':'2026 →',
    'journey.2026':'BLCU 교환학생 · 서강대 조교 · 공개 빌딩 중',
    'manifesto.now.label':'지금',
    'manifesto.now.building':'서강대 화학공학 조교',
    'manifesto.now.where':'서울, BLCU 교환학생 복귀',
    'manifesto.now.updated':'2026년 6월 업데이트',
    'langquiz.title':'언어 맞추기',
    'langquiz.sub':'이 언어는 무엇일까요?',
    'langquiz.q':'질문',
    'langquiz.result':'{score}/{total} 정답',
    'langquiz.retry':'다시 하기 →',
