...
export const TRANSLATIONS = {
  en: {
    ...
    'manifesto.story.body':'I grew up in Malaysia, moved to Seoul for university, and ended up building a chemical engineering degree and a software portfolio in parallel. I interpret at government events in the morning and deploy web apps in the evening — not out of obligation, but because both things genuinely interest me. I\'ll graduate in 2027, but I\'ve already shipped 6 production systems, mentored 150+ students, and interpreted for organizations from the Supreme Prosecutors\' Office to Yonhap News at APEC.',
  ...
  zh: {
    ...
    'manifesto.story.body':'我在马来西亚长大，来到首尔求学，最终在同一时期修完了化学工程学位，也搭建起了自己的软件作品集。早上为政府活动担任口译，晚上部署网页应用——不是因为必须，而是因为两件事都真正让我着迷。我将于2027年毕业，但迄今已上线6个生产系统，辅导了150余名学生，服务机构涵盖最高检察院及联合新闻社（APEC）。',
  ...
  ko: {
    ...
    'manifesto.story.body':'말레이시아에서 자라 서울로 유학을 왔고, 그 사이 화학공학 학위와 소프트웨어 포트폴리오를 동시에 쌓아왔습니다. 오전에는 정부 행사에서 통역하고, 저녁에는 웹 앱을 배포합니다 — 의무가 아니라, 둘 다 진심으로 재밌기 때문입니다. 2027년 졸업 예정이지만 이미 6개의 프로덕션 시스템을 출시했고, 150명 이상의 학생을 멘토링했으며, 대검찰청부터 연합뉴스 APEC 보도까지 다양한 기관에서 통역했습니다.',
